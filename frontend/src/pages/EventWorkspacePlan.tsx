...
export function EventPlanSection({ context }: { context: EventWorkspaceContext }) {
  ...
  return <div className="event-workspace-stack">
    ...
    {context.canManage && <div className="event-plan-form-grid">
